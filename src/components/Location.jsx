            ...
            <div className="flex flex-col md:flex-row items-center justify-center pt-[30px]">
                <div className="flex-1">
                    ...
                    <div>
                        ...
                        <button className="rounded-3xl mt-[4%] font-semibold text-[16px] font-serif lg:text-[18px] bg-[#1A3360] text-white hover:text-[#1A3360] hover:bg-white px-[22px] py-[8px] lg:px-[35px]">
                            Check out on Map
                        </button>
